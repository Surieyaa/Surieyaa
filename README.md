...
<img src="https://skillicons.dev/icons?i=python,tensorflow,sklearn,opencv,flask,streamlit,git,github,mysql,vscode&amp;theme=dark&amp;perline=10" alt="tech stack" />
...
<table>
<tr>
<td width="15%"><b>Jan – Feb 2025</b></td>
<td width="30%"><b>Data Science Intern</b><br/>NSIC, Chennai</td>
<td width="55%">Executed end-to-end data workflows — preprocessing, EDA, and ML model implementation — on real-world industry datasets. Collaborated with senior data scientists to adopt production-grade evaluation, validation, and reporting practices.</td>
</tr>
<tr>
<td><b>Jun – Jul 2025</b></td>
<td><b>Python Programming Intern</b><br/>InternPe</td>
<td>Developed and optimised 15+ Python programs, strengthening data structures, algorithms, and file-handling proficiency. Delivered every assigned mini-project ahead of schedule.</td>
</tr>
</table>
...
- 🥇 **Best Student Award** — PPT &amp; Events
- 💻 **150+ problems solved** across HackerRank, LeetCode, and CodeChef
...
<div align="center">
<img src="https://raw.githubusercontent.com/Surieyaa/Surieyaa/output/github-contribution-grid-snake.svg" width="100%" alt="contribution snake animation"/>
</div>

> **One-time setup:** this animated snake eats through your contribution graph automatically, but it needs a small GitHub Action to generate it. Add a workflow file at `.github/workflows/snake.yml` in this `Surieyaa/Surieyaa` repo with the official [`Platane/snk`](https://github.com/Platane/snk) action — it'll regenerate the SVG above daily. Ask me and I'll write the workflow file for you.
...
I'm actively seeking **Data Scientist**, **ML Engineer**, and **Data Analyst** roles where I can take a model from raw data to a deployed, working product. If you're hiring — or just want to talk about calibration curves, RAG pipelines, or free-tier deployment hacks — reach out.

<div align="center">

📧 **surieyaa.s@gmail.com** &nbsp;|&nbsp; 💼 [linkedin.com/in/surieyaa-s](https://linkedin.com/in/surieyaa-s/) &nbsp;|&nbsp; 🐙 [github.com/Surieyaa](https://github.com/Surieyaa)

<img src="https://capsule-render.vercel.app/api?type=soft&amp;color=0:0EA5E9,100:6366F1&amp;height=100&amp;section=footer" width="100%"/>
